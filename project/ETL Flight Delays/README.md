...
This folder defines all source code for the 'ETL Flight Delays' pipeline:
...
* Take a look at the sample under "sample_users_etl_flight_delays.py" to get familiar with the syntax.
